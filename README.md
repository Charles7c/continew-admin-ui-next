...
<a href="https://github.com/Charles7c/continew-admin-ui" target="_blank">
<img src="https://img.shields.io/badge/Vue-3.4.8-%236CB52D.svg" alt="Release" />
</a>
<a href="https://github.com/Charles7c/continew-admin-ui" target="_blank">
<img src="https://img.shields.io/badge/Element Plus-2.5.0-%236CB52D.svg" alt="Release" />
</a>
<a href="https://github.com/Charles7c/continew-admin-ui" target="_blank">
<img src="https://img.shields.io/badge/TypeScript-5.3.3-%236CB52D.svg" alt="Release" />
</a>
<a href="https://github.com/Charles7c/continew-admin-ui" target="_blank">
<img src="https://img.shields.io/badge/Vite-5.0.11-%236CB52D.svg" alt="Release" />
</a>
...
ContiNew Admin 中后台管理框架的下一代前端适配项目（适配中），基于 Fantastic Admin 前端框架基础版开发。
...
当前采用的技术栈：Spring Boot3（Java17）、Vue3 & TS & Vite5 & Element Plus、Sa-Token、MyBatisPlus、Redisson、JetCache、JustAuth、Crane4j、EasyExcel、Liquibase、Hutool 等。
...
| Gitee | [gitee.com/continew/continew-admin-ui](https://gitee.com/continew/continew-admin-ui) | [gitee.com/continew/continew-admin](https://gitee.com/continew/continew-admin) |
...
5. 在 Gitee 或 GitHub 上新建 pull request（pr），选择好源和目标，按模板要求填写说明信息后提交即可（多多参考 [已批准合并的 pr 记录](https://github.com/Charles7c/continew-admin-ui-next/pulls?q=is%3Apr+is%3Amerged)，会大大增加批准合并率）
...
- 感谢 [Fantastic Admin ](https://gitee.com/fantastic-admin/basic) 开箱即用的 Vue 中后台管理系统框架
